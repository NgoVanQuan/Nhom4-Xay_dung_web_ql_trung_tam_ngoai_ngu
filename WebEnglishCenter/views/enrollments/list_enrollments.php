            ...
            <?php if (!empty($success_message)): ?>
                <div class="success-message auto-hide" id="successMessage">
                    ...
                    <button onclick="hideSuccessMessage()"
                        style="margin-left: auto; background: none; border: none; color: #166534; cursor: pointer; font-size: 1.2rem;">&times;</button>
                </div>
            <?php endif; ?>
                ...
                <div class="search-section">
                    <form method="GET" action="" style="display: flex; gap: 12px; align-items: center;">
                        <input type="text" name="search" value="<?= htmlspecialchars($search) ?>"
                            placeholder="Tìm kiếm khóa học..." class="search-box">
